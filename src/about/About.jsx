  ...
  return (
    <div className="mt-20">
      <div className="about flex flex-col items-center justify-center">
        ...
        <p className="text-lg text-center text-gray-300 mb-10 w-[66%]">
          We at Innoveda Solutions turn your ideas into digital magic! From sleek
          websites and mobile apps to smart CRM and marketing, we create solutions
